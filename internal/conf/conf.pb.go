...
type Auth struct {
	...
	WechatToken   string                 `protobuf:"bytes,2,opt,name=wechat_token,json=wechatToken,proto3" json:"wechat_token,omitempty"`
	WechatQrUrl   string                 `protobuf:"bytes,3,opt,name=wechat_qr_url,json=wechatQrUrl,proto3" json:"wechat_qr_url,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Auth) GetWechatToken() string {
	if x != nil {
		return x.WechatToken
	}
	return ""
}

func (x *Auth) GetWechatQrUrl() string {
	if x != nil {
		return x.WechatQrUrl
	}
	return ""
}
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x03llm\x18\x04 \x01(\v2\x0f.kratos.api.LLMR\x03llm\x12$\n" +
	"\x04auth\x18\x05 \x01(\v2\x10.kratos.api.AuthR\x04auth\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\rsystem_prompt\x18\n" +
	" \x01(\tR\fsystemPrompt\"l\n" +
	"\x04Auth\x12\x1d\n" +
	"\n" +
	"jwt_secret\x18\x01 \x01(\tR\tjwtSecret\x12!\n" +
	"\fwechat_token\x18\x02 \x01(\tR\vwechatToken\x12\"\n" +
	"\rwechat_qr_url\x18\x03 \x01(\tR\vwechatQrUrlB\x19Z\x17seas/internal/conf;confb\x06proto3"
